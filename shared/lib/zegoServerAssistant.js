/**
 * ZegoCloud Token04 Generator — vendored from:
 * https://github.com/ZEGOCLOUD/zego_server_assistant/blob/master/token/nodejs/server/zegoServerAssistant.js
 *
 * Converted to ESM, removed console.log debug statements.
 * Original license: MIT (ZEGOCLOUD)
 */
 ...
 *
 * @param {number} appId - App ID from ZegoCloud console
 * @param {string} userId - Unique user identifier
 * @param {string} secret - 32-byte server secret from ZegoCloud console
 * @param {number} effectiveTimeInSeconds - Token validity duration
 * @param {string} [payload=""] - JSON string for privilege control (optional)
