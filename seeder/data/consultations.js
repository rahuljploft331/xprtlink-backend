/** Sample consultations for local seed / Postgres reset */
export const seedConsultations = [
  ...
  { customerIndex: 2, expertIndex: 0, status: "completed", durationMins: 10, amountCents: 4000, daysAgo: 18 },
  { customerIndex: 3, expertIndex: 2, status: "completed", durationMins: 22, amountCents: 8800, daysAgo: 22 },
  { customerIndex: 0, expertIndex: 3, status: "completed", durationMins: 14, amountCents: 5200, daysAgo: 25 },
  { customerIndex: 1, expertIndex: 0, status: "completed", durationMins: 19, amountCents: 7000, daysAgo: 28 },
];
